...
public class ImageAdapterViewBookings extends RecyclerView.Adapter <ImageAdapterViewBookings.ImageViewHolder>{
    private Context mContext;
    private List<UserBooking> mUploads;

    public ImageAdapterViewBookings(Context context, List<UserBooking> userUploads){
        mContext= context;
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        holder.textViewHotelName.setText("Resturant Name: "+uploadCurrent.getBookHotelName());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            textViewHotelName= itemView.findViewById(R.id.image_view_hotelname);
