...
public class UpdateOpen extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res_name_update= (TextView) findViewById(R.id.res_name_update);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                res_name_update.setText(userBooking.getBookHotelName());
                ...
                if (validate()) {
                    if (valSpin()) {
                        ...
                        if (firebaseUser != null) {
                            ...
                            UserBooking userBooking = new UserBooking(u_name, u_phone, u_e_r_date, u_e_r_time, selectedTable, u_hotelName);
    ...
    private Boolean validate(){
        ...
        u_hotelName= res_name_update.getText().toString();
