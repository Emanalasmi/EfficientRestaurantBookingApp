...
public class BookHotel extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    String u_rec_res_name;
    NetworkInfo nInfo;
    Spinner spinner_table;
    String selectedTable;
    TextView rec_res_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rec_res_name= findViewById(R.id.rec_res_name);

        Intent intent= getIntent();
        u_rec_res_name = intent.getStringExtra("Restaurant_name");
        rec_res_name.setText(u_rec_res_name);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookHotel.this,
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(BookHotel.this,
                ...
                if (validate()) {
                    if (valSpin()){
                        ...
                        if (firebaseUser != null) {
                            ...
                            UserBooking userBooking = new UserBooking(u_name, u_phone, u_e_r_date, u_e_r_time, selectedTable, u_rec_res_name);
                            ref.child(ref.push().getKey()).setValue(userBooking);
                            Toast.makeText(BookHotel.this, "Table Reservation Successfully Completed", Toast.LENGTH_LONG).show();
                            startActivity(new Intent(BookHotel.this, HomePage.class));
                            finish();
                        }
                    }
                }
