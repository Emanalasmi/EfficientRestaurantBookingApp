...
public class UpdateBooking extends AppCompatActivity implements ImageAdapterUpdateBooking.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapterUpdateBooking(UpdateBooking.this, mUploads);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(UpdateBooking.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if (postSnapshot.exists()){
                        ...
                        Toast.makeText(UpdateBooking.this, "There is no table reservation yet", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UpdateBooking.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(UpdateBooking.this, UpdateOpen.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(UpdateBooking.this, HomePage.class));
        finish();
