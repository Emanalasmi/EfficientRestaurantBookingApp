...
public class ViewBooking extends AppCompatActivity {
    ...
    private ImageAdapterViewBookings mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapterViewBookings(ViewBooking.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if (postSnapshot.exists()){
                        ...
                        Toast.makeText(ViewBooking.this, "There is no table reservation yet", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ViewBooking.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
